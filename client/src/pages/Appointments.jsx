    ...
    <section className="max-w-7xl mx-auto md:px-9 px-5 mb-16">
      ...
      >
        ...
        <img
          ...
          alt="Login Banner"
          className="w-40 absolute bottom-0 right-40 max-md:right-10 z-0"
        />
      </div>
      <div className="flex-col">
        ...
        {appointments.length === 0 ? (
          <p className="text-center pb-20 pt-16 text-2xl text-[#353452] flex-center gap-2">
            No appointments found <RxShadowNone />
          </p>
        ) : (
                ...
                >
                  {user.type === "manager" ? (
                    <div className="flex md:items-center md:flex-row flex-col md:gap-10 gap-1 text-xs text-gray-600">
                      <p className="md:flex hidden flex-col ">
                        Status:{" "}
                        <span className="text-white px-6 py-1 text-base font-medium rounded-full bg-gradient-to-r from-pink-400 to-rose-500">
                          {appointment.status}
                        </span>
                      </p>
                      <img
                        src={
                          appointment.driverId?.image
                            ? appointment.driverId.image
                            : defaultImage
                        }
                        alt="Profile"
                      ...
                      <p className="flex flex-col">
                        Vehicle:{" "}
                        <span className="font-medium text-lg text-[#353452]">
                          {appointment.vehicleId?.name}
                        </span>{" "}
                      </p>
                      <p className="hidden max-md:flex flex-col ">
                        Status:{" "}
                        <span className="text-white text-center px-6 py-1 text-base font-medium rounded-full bg-gradient-to-r from-pink-400 to-rose-500">
                          {appointment.status}
                        </span>
                      </p>
                    </div>
                    ...
                    <div className="flex md:items-center md:flex-row flex-col md:gap-10 gap-1 text-xs text-gray-600">
                      ...
                      <p className="flex flex-col">
                        Customer:{" "}
                        <span className="font-medium text-lg text-[#353452]">
                          {appointment.managerId?.name}
                        </span>
                      </p>
                      <p className="flex flex-col">
                        Email:{" "}
                        <span className="font-medium text-lg text-[#353452]">
                          {appointment.managerId?.email}
                        </span>
                      </p>
                      <p className="flex flex-col">
                        Start Date:{" "}

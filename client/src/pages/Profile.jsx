...
const Profile = () => {
  ...
  return (
    <form
      ...
      className="max-w-7xl mx-auto md:px-9 px-5 mb-20"
    >
      <div
        className="rounded-lg bg-gradient-to-r from-fuchsia-200 via-indigo-100 to bg-purple-300 h-[150px] bg-cover"
        style={{
          backgroundImage:
            "url(https://png.pngtree.com/thumb_back/fh260/background/20220511/pngtree-abstract-pastel-purple-gradient-background-ecology-concept-for-your-graphic-design-image_1324968.jpg)",
        }}
      ></div>
      <div className="rounded-lg flex gap-5 lg:flex-row flex-col justify-between  px-5 pb-5 md:px-10 md:pt-5 pt-3 relative">
        <div className="flex-1">
          <div className="flex gap-10 items-start justify-start">
            <div
              {...getRootProps()}
              className="bg-gray-100 md:w-48 md:h-48 w-36 h-36 rounded-xl object-cover absolute md:top-[-90px] top-[-70px] border-[5px] border-white cursor-pointer"
            >
              <input {...getInputProps()} />
              {image ? (
                <img
                  src={image}
                  alt="Profile"
                  className="md:w-48 md:h-48 w-36 h-36 rounded-xl object-cover"
                />
              ) : (
        ...
        <div className="flex-1 flex flex-col w-full mx-auto mt-4 px-2 gap-5">
          <h2 className="lg:ps-6 text-2xl font-medium text-[#353452] mb-1">
            Details
          </h2>
          <div className="flex">
            <div className="w-[9px] rounded-full bg-gradient-to-b from-fuchsia-500 to-indigo-400"></div>
            <div className="flex w-full flex-col gap-4 ms-5 md:mr-20 mr-5">
              <div className="flex flex-col">
                <h3 className=" text-xl font-medium text-[#353452] mb-1  flex items-center gap-2 ">
      ...
      <div className="flex-center gap-2 mb-10">
        ...
        <button
          type="submit"
          className="px-3 text-lg  font-medium text-white py-2 rounded-[2px] bg-gradient-to-r from-pink-400 to-rose-500 hover:from-pink-500 hover:to-rose-600 duration-300"
        >
          Update Details
        </button>
      </div>

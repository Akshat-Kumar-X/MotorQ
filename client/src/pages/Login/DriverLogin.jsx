...
const DriverLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await axios.post(`${BASE_URL}/api/driver-login`, {
        email,
        password,
      });
            ...
            <div className="flex-1 flex items-center">
              <div className="flex flex-col w-full bg-white p-10 text-black rounded-md ">
                ...
                <p className="mb-4 text-gray-500">
                  Connect With Drivers Around the World
                </p>
                <form onSubmit={handleSubmit} className="flex flex-col ">
                  ...
                  <button
                    type="submit"
                    className="bg-gradient-to-r text-xl text-white font-bold from-fuchsia-400 to-purple-500  py-1 rounded-md  duration-150"
                  >
                    Submit
                  </button>
                </form>

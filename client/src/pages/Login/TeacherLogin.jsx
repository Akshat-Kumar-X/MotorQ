            ...
            <div className='flex-1 flex items-center'>
              <div className='flex flex-col w-full bg-white p-10 text-black rounded-md '>
                ...
                <h1 className='text-[#353452] text-5xl  font-semibold mb-5'>
                  <span className='bg-gradient-to-r from-pink-400 to-rose-500 text-transparent bg-clip-text font-bold'>Driver</span> Login
                </h1>
                <p className='mb-4 text-gray-500'>Connect With Drivers Around the World</p>
                <form onSubmit={handleSubmit} className='flex flex-col '>
                  ...
                  <button type='submit' className='bg-gradient-to-r text-xl text-white font-bold from-fuchsia-400 to-purple-500  py-1 rounded-md  duration-150'>
                    Submit
                  </button>
                </form>

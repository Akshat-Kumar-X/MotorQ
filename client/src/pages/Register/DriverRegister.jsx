...
const DriverRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await axios.post(`${BASE_URL}/api/driver-register`, {
        name,
        email,
        password,
        contact,
            ...
            <div className="flex-1 flex items-center">
              <div className="flex flex-col w-full bg-white p-10 text-black rounded-3xl ">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col ">
                  ...
                  <label
                    htmlFor="email"
                    className="text-sm text-[#353452] ms-1 mt-2"
                  >
                    Email
                  </label>
                  <input
                  ...
                  <label
                    htmlFor="password"
                    className="text-sm text-[#353452] ms-1 mt-3"
                  >
                    Password
                  </label>
                  <input
                ...
                <p className="mt-3 text-gray-600">
                  Already registered?{" "}
                  <Link to="/driver-login" className="text-blue-500 underline">
                    Login
                  </Link>
                </p>
              </div>

...
const DriverProfile = () => {
  ...
  const handleAppointmentSubmit = async (e) => {
    ...
    if (user.type === "driver") {
      toast.error("Only Manager can schedule appointments");
      return;
    }
  ...
  if (!driver) {
    return (
      <div className="text-[#353452] text-3xl font-semibold max-w-7xl mt-20 flex-center">
        Loading...
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto md:px-9 px-5">
      <div className="relative rounded-lg bg-gradient-to-r from-fuchsia-200 via-indigo-100 to bg-purple-300 h-[150px] bg-cover">
        {user && user._id === id && (
          <Link
            to="/profile"
            className="absolute shadow-lg bottom-5 right-5 text-xl font-bold flex-center gap-2 text-white py-2 px-3 rounded-sm bg-gradient-to-r from-fuchsia-400 to-purple-600 hover:from-fuchsia-500 hover:to-purple-700 duration-300"
          >
            {" "}
            <FaEdit /> Edit
          </Link>
      ...
      <div className="rounded-lg flex md:flex-row flex-col justify-between px-5 pb-20 md:px-10 md:pt-5 pt-3 relative">
        <div>
          <div className="flex gap-10 items-start justify-start">
            ...
            <div className="flex flex-col gap-2">
              <h1 className="md:text-3xl text-2xl font-bold text-[#353452] md:ps-52 ps-40">
                {driver.name}
              </h1>
            </div>
          </div>
          ...
          <div className="flex flex-col mx-auto mt-2 px-2 gap-5">
            <h2 className="text-2xl font-medium text-[#353452] mb-1">
              Details
            </h2>
            <div className="flex">
              ...
              <div className="flex flex-col gap-4 ms-5 mr-20">
                <div className="flex flex-col">
                  ...
                  <p className="font-medium bg-gradient-to-r from-fuchsia-500 to-indigo-400 text-transparent bg-clip-text">
                    +91 {driver.contact}
                  </p>
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col">
                  <h3 className="text-xl font-medium text-[#353452] mb-1 flex items-center gap-2">
                    <BsClockHistory /> Years of experience
                  </h3>
                  <p className="font-medium bg-gradient-to-r from-fuchsia-500 to-indigo-400 text-transparent bg-clip-text">
        ...
        <div className="pt-20 text-[#353452]">
          <div className="min-w-[300px] border-4 border-white px-5 py-10 rounded-xl shadow-lg bg-gradient-to-r from-fuchsia-100 via-indigo-50 to bg-purple-50">
            <h2 className="text-xl font-bold text-center mb-4 text-[#353452]">
              Schedule
              <span className="bg-gradient-to-r from-pink-400 to-rose-500 text-transparent bg-clip-text ps-2">
                Appointment
              </span>
            </h2>
            <form onSubmit={handleAppointmentSubmit}>
              <div className="mb-4">
                <label className="block text-gray-700 font-medium ps-1">
                  Start Date & Time
                </label>
                <input
                  type="datetime-local"
              ...
              {message && (
                <p className="mt-2 text-center text-[#353452] font-medium">
                  {message}
                </p>
              )}
            </form>
